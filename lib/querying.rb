...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series INNER JOIN series ON characters.series_id = series.id GROUP BY (series.title)
  ORDER BY COUNT(characters.species) DESC HAVING characters.species = 'human' LIMIT 1;"
end
